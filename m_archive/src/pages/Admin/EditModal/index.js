    ...
    if(type==="review"){
        return(
            <section className={styles.reviewWrapper}>
                <Input name="score" type="number" className={cx(styles.score)} label={"별점 : "} value={reviewForm?.score} onChange={onChangeReview}/>
                <div className={styles.review}>
                    <label for="review"><p>리뷰 :</p> </label>
                    <textarea name="content" id="review" value={reviewForm?.content} onChange={onChangeReview} />
                </div>
        ...
        return(
            <section className={styles.userWrapper}>
                <Input name="email" className={styles.userInput} label={"이메일 : "} value={userForm?.email} onChange={onChangeUser}/>
